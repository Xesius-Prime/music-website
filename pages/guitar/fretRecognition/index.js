    ...
    return (
        <div>
            ...
            <div className={globalStyle.flex}>
                <button><Link href="/guitar/fingerRecognition/game">Back to: <br /> Finger Names Game</Link></button>
                <button><Link href="/guitar/fretRecognition/game">Continue to: <br /> Tab to Fretboard Game</Link></button>
            </div> <br /> <br /> <br />
        </div>
    )
}
