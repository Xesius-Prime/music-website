    ...
    return (
        <div>
            ...
            <div className={globalStyle.flex}>
                <button><Link href="/rhythm/quarterNotes">Back to: <br /> Quarter Notes</Link></button>
                <button><Link href="/rhythm/rhythmTrainer">Continue to: <br /> Rhythm Lesson & Game</Link></button>
            </div> <br /> <br /> <br />
        </div>
    )
}
