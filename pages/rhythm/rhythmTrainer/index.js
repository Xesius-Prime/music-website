...
export default function index() {
    return (
        <div>
            <h1>Rhythm Trainer <br /> Lesson & Game Link</h1>
            ...
            <div className={globalStyle.flex}>
                <button><Link href="/rhythm/eighthNotes">Back to: <br /> Eighth Notes</Link></button>
                <button><Link href="">Continue to: <br /> The Next Thing</Link></button>
            </div> <br /> <br /> <br />
