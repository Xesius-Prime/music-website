...
export default function index() {
    return (
        <div>
            ...
            <iframe src="https://www.youtube.com/embed/xvCLBGlhhrE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen className={globalStyle.video}></iframe><br /><br /><br />
