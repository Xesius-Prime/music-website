    ...
    return (
        <div>
            ...
            <div className={globalStyle.flex}>
                <button><Link href="/guitar/fingerRecognition/game">Back to: <br />Left Hand & <br /> Right Hand Lesson</Link></button>
                <button><Link href="/misc">Continue to: <br />Misc Overview</Link></button>
            </div> <br /> <br /> <br />
        </div>
    );
}
