    ...
    return (
        <div>
            ...
            <div className={globalStyle.flex}>
                <button><Link href="/misc">Back to: <br />Misc<br /> Overview</Link></button>
                <button><Link href="/misc/leftHandRightHand/game">Continue to: <br />Left Hand & <br /> Right Hand Game</Link></button>
            </div> <br /> <br /> <br />
        </div>
    );
}
