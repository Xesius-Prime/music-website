    ...
    return (
        <div>
            ...
            <div className={globalStyle.flex}>
                <button><Link href="/method/rhythm">Back to: <br />Rhythm Overview</Link></button>
                <button><Link href="/method/rhythm/eighthNotes">Continue to: <br />Eighth Notes</Link></button>
            </div> <br /> <br /> <br />
        </div>
    )
}
