...
export default function index() {
    ...
    return (
        <div className={globalStyles.center}>
            <h1>Guitar</h1>
            <h2>String Names<br /> Game</h2><br /><br />
            ...
            <div className={globalStyles.flex}>
                <button><Link href="/method/guitar/stringRecognition">Back to: <br /> String Name Lesson</Link></button>
                <button><Link href="/method/guitar/fingerRecognition">Continue to: <br /> Finger Names</Link></button>
            </div> <br /> <br /> <br />
        </div>
    )
}
