            ...
            <div className={styles.main}>
                ...
                <div className={styles.bottomPart}>
                    ...
                    <div className={globalStyles.flex}>
                        <button><Link href="/method/guitar/fretRecognition">Back to: <br /> Tabs for Guitar Lesson</Link></button>
                        <button><Link href="/method/guitar/findNoteOnString">Continue to: <br /> Find Note On String Lesson</Link></button>
                    </div><br /> <br />
                </div>
            </div>
        </div>
