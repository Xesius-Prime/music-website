    ...
    return (
        <div className={globalStyle.center}>
            ...
            <div className={globalStyle.flex}>
                <button>
                    <Link href="/method/piano/clefRecognition">Back to: <br />Finger Name Game</Link>
                </button>

                <button>
                    <Link href="/method/piano/keyRecognition">Continue to: <br />Key Recognition Lesson</Link>
                </button>
            </div> <br /> <br /> <br />
