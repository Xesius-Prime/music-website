    ...
    return (
        <div className={globalStyle.center}>
            ...
            <div className={globalStyle.flex}>
                <button>
                    <Link href="/method/piano/keyRecognition/blackKeys">Back to: <br />Why Learn <br /> Key Names?</Link>
                </button>

                <button>
                    <Link href="/method/piano/keyRecognition/whiteKeys">Continue to: <br />White Keys <br /> Lesson & Game</Link>
                </button>
            </div> <br /> <br /> <br />
        </div>
    )
